...
# Listado de archivos raster de índices
...
# Extracción de años de los nombres de los rasters y emparejamiento
...
for (tipo_indice in seq_along(archivos_indices)) {
  for (archivo_indice in archivos_indices[[tipo_indice]]) {
    ...
    for (nombre_relieve in names(rasters_relieve)) {
      ...
      # Cálculo de correlación de Spearman entre rasters de relieve e índices
